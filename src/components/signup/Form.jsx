  ...
  return (
    <form className="flex flex-col gap-8 register-form max-w-[1000px]">
      <div className="flex flex-col gap-1 w-full">
        ...
        <input className="h-[50px] pl-3 rounded-lg brd" type="text" name="company-name" id="company-name" />
      </div>
      ...
      <div className="flex sm:flex-col items-center gap-3">
        <div className="flex flex-col gap-1 w-full">
          ...
          <input className="h-[50px] pl-3 rounded-lg brd" type="text" name="company-type"  id="company-type" />
        </div>
        <div className="flex flex-col gap-1 w-full">
      ...
      <div className="flex sm:flex-col items-center gap-3">
        <div className="flex flex-col gap-1 w-full">
          ...
          <select className="h-[50px] pl-3 rounded-lg brd" name="country" id="country">
        ...
        <div className="flex w-full gap-3">
          <div className="flex flex-col gap-1 w-full">
            ...
            <select className="h-[50px] pl-3 rounded-lg brd" name="" id="state">
              {state.map((states) => {
                return <option value={"Lagos"} key={"Lagos"}>Lagos</option>;
              })}
            </select>
          </div>
        </div>
      ...
      <div className="flex sm:flex-col items-center gap-3">
        <div className="flex flex-col gap-1 w-full">
          ...
          <input className="h-[50px] pl-3 rounded-lg brd" type="text" name="tel-number" id="tel-number" />
        </div>
        <div className="flex flex-col gap-1 w-full">
          <label htmlFor="url" className="flex items-start">
            Website URL (Optional)
          </label>
          <input className="h-[50px] pl-3 rounded-lg brd" type="text" name="url" id="url" />
        </div>
      </div>
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="flex flex-col gap-1 w-full">
          ...
          <input className="h-[50px] pl-3 rounded-lg brd" type="text" name="confirm-password" id="confirm-password" />
        </div>
      </div>
      ...
      <div className="flex gap-2">
        ...
        />
        <p>
          I accept the <span className="text-[#39d8fc]">Terms of Service</span>{" "}
          as well as <span className="text-[#39d8fc]">Privacy Policy.</span>
        </p>
      </div>
      ...
      <p className="text-center cursor-pointer">
          Already have an account? <span className="text-[#39d8fc]" onClick={() => setActive(true)} >Login</span>{" "}
