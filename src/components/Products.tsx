...
const Products = () => {
  return (
    <div className='w-[90%] mx-auto'>
        ...
        <div className='flex sm:flex-col lg:flex-wrap gap-5 sm:gap-7'>
            {data.map((data, idx) => {
                ...
                return (
                    <div className='flex-1'>
                        ...
                        <button className='uppercase mt-3 w-full  transition-all duration-300 ease-in hover:bg-[#39d8fc] rounded-lg py-3 font-semibold text-sm' style={{border: '1px solid #2EA2BD'}}>Add to cart</button>
                    </div>
                )
            })}
        </div>
